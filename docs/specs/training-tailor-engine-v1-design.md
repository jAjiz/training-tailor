...
- **Movement:** name, patterns[] (functional movement pattern enum, primary first:
  ...
  ghd | band | rope | jump_rope | rower | ski_erg | bike | air_bike | wall_ball | sandbag | d_ball` — an AND-set matched by subset against the
...
- **Minimum viable seed size:** ~111 movements, 18 contraindication entries
